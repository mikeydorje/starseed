...
function animate() {
  ...
  particles.rotation.y = elapsed * rotSpeedY * (arc.rot || 1) * (1.0 + rd) * 0.6;
  particles.rotation.x = elapsed * rotSpeedX * 0.15 * (arc.rot || 1) * (1.0 + td) * 0.6;
...
window.SCENE = {
  ...
  rotXMult: 0.0525, rotDriftScale: 0.23, tiltDriftScale: 0.16,
