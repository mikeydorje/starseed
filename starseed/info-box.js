...
(function () {
  ...
  box.innerHTML = `
    ...
    <p>Hit <strong>⏺︎ Record</strong> to capture video in <strong>16:9</strong>, <strong>1:1</strong>, or <strong>9:16</strong>. The visuals are boundary aware and adapt to each format. <strong>Boundary</strong> toggles this on/off. <strong>⏣&nbsp;Aperture Scale</strong> adjusts the field of view — use it to reframe the composition for each format.</p>
