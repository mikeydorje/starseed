...
|-------|--------|----------|-----------------|
| **Original** (6) | Binary SMBH, Lotus, Aevum, Filament, Spore, Lattice | **Deterministic** — concentric rings, layered petals, strand grids, computed density | Physical displacement (jets, ripples, curls, tension snaps) |
